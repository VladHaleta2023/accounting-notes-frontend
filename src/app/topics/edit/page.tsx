...
export default function EditCategoryPage() {
    ...
    useEffect(() => {
        ...
        const storedTopicName = sessionStorage.getItem("activeTopicName");
        const storedCategory = sessionStorage.getItem("activeCategory");

        setActiveTopic(storedTopic || "");
        setActiveTopicName(storedTopicName || "");
    ...
    async function onConfirm() {
        try {
            if (await ApiTopic.updateTopic(activeCategory, activeTopic, activeTopicName))
                router.push("/topics");
        } catch (error) {
